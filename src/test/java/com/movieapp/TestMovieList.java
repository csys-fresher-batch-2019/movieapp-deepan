...
public class TestMovieList {
	...
	private static void testRecentMovies() throws DbException {
		...
		for (MovieList movie : list) {
			System.out.println("[MovieName: " + movie.getMovieName() + ",MovieLanguage: " + movie.getMovieLanguage()
					+ ",MovieType: " + movie.getMovieType() + ",MovieRating: " + movie.getMovieRating()
					+ ",MovieDuration: " + movie.getMovieDuration() + " , ReleasedDate: " + movie.getReleasedDate()
					+ "]");
		}
	}
